...
bool isAvailable(std::string s) {
    if (s == "create" || s == "drop" ||s == "selct" || s == "table" || s == "insert" || s == "alter" || s == "update" || s == "order" || s == "having" || s == "not" || s == "null" || s == "references" || s == "on" || s == "use" || s == "delete" || s == "by" || s == "desc" || s == "asc" || s == "group" || s == "distinct" || s == "from" || s == "limit" || s == "where" || s == "in" || s == "like" || s == "values" || s == "into" || isDataTypeCheck(s)) {
        return false;
    }
    return true;
}
        ...
        try {
                ...
                while (v1[a] != ")") {
                    if (isAlphaCheck(v1.at(a)) && !isDataTypeCheck(v1.at(a)) && isDataTypeCheck(v1.at(a + 1))) {
                        ...
                        if (v1.at(a + 2) == ",") {
                            ...
                            keys[foreignKey] = v1Copy.at(a) + "." + v1Copy.at(a+5) + v1Copy.at(a + 6) + v1Copy.at(a + 7) + v1Copy.at(a + 8);
                            fkeyCheck = true;
                            foreignKey.clear();
                            fkCount++;
                            if (v1.at(a + 9) == ",") {
            ...
            else if (v1.at(i) + v1.at(i + 1) == "insertinto" && isAlphaCheck(v1.at(i + 2)) && isAvailable(v1.at(i + 2)) && v1.at(i + 3) == "values")
            {
                            ...
                            if (v1.at(counter) != ",") {
                                ...
                                if (v1.at(counter) == "'") {
                                    ...
                                    v1.at(counter).erase(remove_if(v1.at(counter).begin(), v1.at(counter).end(), ::isspace),
                                        v1.at(counter).end());*/
                                    if (isdigit(v1Copy.at(counter + 1)) ){
                                        stringNumCheck = true;
                                    }
                                    ...
                                    if (isAlphaCheck(s1) || isdigit(s1)) {
                                        ...
                                        p1.first = ((s1 == "true" || s1 == "false") || (s1 == "True" || s1 == "False") || (s1 == "TRUE" || s1 == "FALSE") || stringNumCheck) ? "class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >" : getDataType(s1);
                                        p1.second = s1;
                                        check2 = true;
                                    }
                                    if (stringNumCheck) {
                                        stringNumCheck = false;
                                    }
                ...
                while (v1.at(a) != ";" && check != false) {
                    if (v1.at(a) == "*") {
                    ...
                    else if (isAlphaCheck(v1.at(a))&& isAvailable(v1.at(a)) && !isDataTypeCheck(v1.at(a)) && v1.at(a - 1) == "select") {
                        b = a;
                        ...
                        if (v1.at(a + 1) == "set") {
                            ...
                            while (v1.at(a) != ";" && v1.at(a) != "where") {
                                ...
                                else if (isAlphaCheck(v1.at(a)) && !isDataTypeCheck(v1.at(a)) && v1.at(a + 1) == "=" && (v1.at(a + 2) == "true" || v1.at(a + 2) == "false")) {
                                    p.first = v1Copy.at(a);
                                    p.second = v1Copy.at(a + 2);
                                    updateQuery.second.push_back(p);
                                    a += 3;
                        ...
                        a++;
                        while (v1.at(a) != ";" && (v1.at(a) + v1.at(a + 1) != "orderby") && (v1.at(a) + v1.at(a + 1) != "groupby")) {
                            ...
                            if (isAlphaCheck(v1.at(a)) && !isDataTypeCheck(v1.at(a))) {
                                ...
                                if (v1.at(a + 1) + v1.at(a + 2) == "!=" || v1.at(a + 1) + v1.at(a + 2) == "<=" || v1.at(a + 1) + v1.at(a + 2) == ">=") {
                                    ...
                                    else if (v1.at(a + 2) == "true" || v1.at(a + 2) == "false") {
                                        tupleTemp = make_tuple(v1Copy.at(a), v1Copy.at(a + 1), v1Copy.at(a + 2));
                                        whereSelect.first.push_back(tupleTemp);
                                        whereCheck = true;
                                        a += 3;
                                ...
                                if (v1.at(a) != ";") {
                                    if ((v1.at(a) + v1.at(a + 1) != "orderby") && (v1.at(a) + v1.at(a + 1) != "groupby")) {
                        ...
                        if (isAlphaCheck(v1.at(a + 1)) && !isDataTypeCheck(v1.at(a + 1)) && v1.at(a + 2) == "on") {
                            ...
                            if (isAlphaCheck(v1.at(a + 3)) && !isDataTypeCheck(v1.at(a + 3)) && v1.at(a + 4) == "." && isAlphaCheck(v1.at(a + 5)) && !isDataTypeCheck(v1.at(a + 5)) && v1.at(a + 6) == "=" && isAlphaCheck(v1.at(a + 7)) && !isDataTypeCheck(v1.at(a + 7)) && v1.at(a + 8) == "." && isAlphaCheck(v1.at(a + 9)) && !isDataTypeCheck(v1.at(a + 9))) {
                                ...
                                if (v1.at(a + 3) != v1.at(a-1) || v1.at(a + 7) != v1.at(a+1)) {
                                    check = false;
                                    break;
                                }
